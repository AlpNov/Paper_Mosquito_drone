...
The 3DR Solo drone weighs 2 kg with diameter 0.71 m\footnote{https://3dr.com/solo-gopro-drone-specs/}. The acceleration due to gravity is 9.871 $\frac{m}{s^2}$.  Substituting these values into \eqref{eq:dronePropwash} gives $v_d = 5.6$ m/s.

\todo{change footnote to reference}
